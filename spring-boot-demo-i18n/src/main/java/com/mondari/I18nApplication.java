...
public class I18nApplication {
    ...
    public Map<String, Object> get(HttpServletRequest request) {
        ...
        Object[] args = {"boys", "girls"};
        sourceMap.put(KEY_GREETINGS, messageSource.getMessage(KEY_GREETINGS, args, locale));
        ...
        bundleMap.put(KEY_GREETINGS, MessageFormat.format(bundle.getString(KEY_GREETINGS), args));
